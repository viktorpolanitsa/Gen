Готово. Я обновил `README.md`, заменив ссылку для скачивания на ту, которую вы указали. Я также убрал примечание о возможном несовпадении имени репозитория, так как теперь ссылка точная.

Вот финальная, полностью адаптированная версия `README.md`.
