...
# modules, including cron, are present and accounted for.
...
load_config() {
  ...
  if [[ ! -f "$CONFIG_FILE" ]]; then
    ...
    # Using printf for safer multi-line writing
    printf '%s\n' \
